...
function showNotification(notifyText){
  toastr.success(notifyText, null, {"positionClass": "toast-bottom-left"});
}
...
function notifySubmit() {
  ...
  $.post('http://localhost/chat-pusher-real-time-app/public/notifications/notify', data).success(notifySuccess);
